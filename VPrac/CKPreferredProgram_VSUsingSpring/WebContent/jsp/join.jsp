			...
			<div id="join">
				* Indicates mandatory fields & must be entered <br> <br>
				...
				<div align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select
						name="storeId" id="store" style="height: 30px">
				...
				<div>
					...
					<table align="center">
						...
						<tr>
							...
							<td align="left"><input type="text" name="adr.country" />&nbsp;*</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							...
							<td align="left"><input type="text" name="adr.state" />&nbsp;*</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							...
							<td align="left"><input type="text" name="adr.address1" />&nbsp;*</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							...
							<td align="left"><input type="text" name="adr.address2" />&nbsp;*</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							...
							<td align="left"><input type="text" name="adr.city" />&nbsp;*</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							...
							<td align="left"><input type="text" name="adr.zip" />&nbsp;*</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
