		...
		<div id="layout1">
			...
			<div id="box">
				<b>Existing members <a
					href="./login">log in</a></b><br>
				<br> If you are an existing member and have already registered
				online for the Calvin Klein Preferred Program, you can login to view
				your points balance or update member enrollment information online.
				login to add the purchase to your account.
			</div>
			<br>
			<div id="box">
				<b>Get started </b><br> <br>Did you know that by
				completing your profile, you will also earn points towards your next
				reward? registering or completing your profile takes just a few
				minutes. please click below to proceed: <br>
				<p align="center">
					<a href="./getStarted">Get
						Started</a>
				</p>
			</div>
		</div>
