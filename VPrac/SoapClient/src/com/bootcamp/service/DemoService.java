 ...
 * 
 */
@WebServiceClient(name = "DemoService", targetNamespace = "http://service.bootcamp.com/", wsdlLocation = "http://localhost:7001/SoapWebService/DemoService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICE_QNAME = new QName("http://service.bootcamp.com/", "DemoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7001/SoapWebService/DemoService?wsdl");
    ...
    public Demo getDemoPort() {
        return super.getPort(new QName("http://service.bootcamp.com/", "DemoPort"), Demo.class);
    }
    ...
    public Demo getDemoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.bootcamp.com/", "DemoPort"), Demo.class, features);
    }
